...
import me.ritabrata.myhealth.activity.RegistrationActivity;
...
public class UserModel {
    ...
    public static void registerNewUser(String name, String mobileNo, String address, String dob, String bloodGroup, final MyTaskCallback callback) {
        ApiInterface apiService =
                ApiClient.getClient().create(ApiInterface.class);
        apiService.newUserReg(name, mobileNo, address, dob, bloodGroup).enqueue(new Callback<responseNewUserReg>() {
            @Override
